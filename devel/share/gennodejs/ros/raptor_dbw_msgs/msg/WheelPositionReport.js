...
class WheelPositionReport {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.wheel_pulses_per_rev = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('wheel_pulses_per_rev')) {
        this.wheel_pulses_per_rev = initObj.wheel_pulses_per_rev
      }
      else {
        this.wheel_pulses_per_rev = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [wheel_pulses_per_rev]
    bufferOffset = _serializer.float32(obj.wheel_pulses_per_rev, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [wheel_pulses_per_rev]
    data.wheel_pulses_per_rev = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.wheel_pulses_per_rev !== undefined) {
      resolved.wheel_pulses_per_rev = msg.wheel_pulses_per_rev;
    }
    else {
      resolved.wheel_pulses_per_rev = 0.0
    }
