...
(cl:defmethod cl:initialize-instance :after ((m <ParkingBrake>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParkingBrake)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raptor_dbw_msgs-msg:<ParkingBrake> is deprecated: use raptor_dbw_msgs-msg:ParkingBrake instead.")))
